...
approve_reimbursement = Reimbursement(4, 3, 1, 500, "Approved", "New Work Laptop", "")
...
def test_get_reimbursement_by_id_success():
    ...
    assert returned_reimbursement.employee_id == 1
...
def test_get_reimbursement_by_approval_success():
    ...
    assert returned_reimbursement_by_approval.manager_id == 2
...
def test_comment_on_reimbursement_success():
    commented_reimbursement: Reimbursement = reimbursement_dao.leave_comment_on_reimbursement(comment_reimbursement)
...
def test_get_past_reimbursements_by_manager_id_success():
    past_reimbursements_list: list[Reimbursement] = reimbursement_dao.get_past_reimbursements_by_manager_id(1, "Approved" or "Denied")
